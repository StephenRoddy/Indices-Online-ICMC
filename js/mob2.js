let sentiment,prediction,saScore,sntMnt, indNum, cover,audio,corpus,index9,index15,index18,index22,index24,index27,index32,index46,index47,index51,toggleBtn,txtNotes, ganVid, ganVid1,ganVid2,ganVid3,ganVid4, vidInd;
let bassMap_Red =0;
let midMap_Green =0;
...
function preload() {
    ...
    ganVid1 = createVideo("/video/SeaGan1.mp4");
    ganVid2 = createVideo("/video/SkyGan1.mp4");
    ganVid3 = createVideo("/video/SeaGan3.mp4");
    ganVid4 = createVideo("/video/SkyGan2.mp4");
}
...
function setup() {
    ...
    ganArr = [ganVid1,ganVid2,ganVid3,ganVid4];
    ganVid = ganArr[1];
