let sentiment,prediction,saScore,sntMnt, indNum, cover,audio,corpus,index9,index15,index18,index22,index24,index27,index32,index46,index47,index51,toggleBtn,txtNotes,ganVid1,ganVid2,ganVid3,ganVid4;
let bassMap_Red =0;
let midMap_Green =0;
...
function preload() {
    ...
    ganVid1 = createVideo("video/SkyGan4.mp4");
    ganVid2 = createVideo("video/SkyGan5.mp4");
    ganVid3 = createVideo("video/SeaGan1.mp4");
    ganVid4 = createVideo("video/SeaGan2.mp4");
